...
from nisystemlink.clients.testplan.testplans.models import (
    TestPlan,
...
class TestPlansClient(BaseClient):
    ...
    @post("schedule-testplan", args=[Field("schedule")])
    ...
    @post("update-testplan", args=[Field("test_plan")])
    def update_test_plan(self, test_plan: UpdateTestPlansRequestBody) -> UpdateTestPlansResponse:
        """Update a test plan.
